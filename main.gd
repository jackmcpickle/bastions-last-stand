...
func _run_simulation(args: Array) -> void:
	...
	var regen_data: EnemyData = load("res://resources/enemies/regen.tres")
	var mini_data: EnemyData = load("res://resources/enemies/mini.tres")
	var boss_golem_data: EnemyData = load("res://resources/enemies/boss_golem.tres")
	var swarm_queen_data: EnemyData = load("res://resources/enemies/swarm_queen.tres")
	var frost_wyrm_data: EnemyData = load("res://resources/enemies/frost_wyrm.tres")
	var phase_phantom_data: EnemyData = load("res://resources/enemies/phase_phantom.tres")
	var necromancer_data: EnemyData = load("res://resources/enemies/necromancer.tres")
	var iron_colossus_data: EnemyData = load("res://resources/enemies/iron_colossus.tres")
	...
	runner.register_enemy(regen_data)
	runner.register_enemy(mini_data)
	runner.register_enemy(boss_golem_data)
	runner.register_enemy(swarm_queen_data)
	runner.register_enemy(frost_wyrm_data)
	runner.register_enemy(phase_phantom_data)
	runner.register_enemy(necromancer_data)
	runner.register_enemy(iron_colossus_data)
